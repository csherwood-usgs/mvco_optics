% p_fit_times_mo_new2 - Sent by Emmanual in late July
...
% plotdir = 'maria'
%
ydt = [261:(1/3)/24:261.3,268+(2/3)/24:(1/3)/24:269,275:(1/3)/24:276];%,281+(2/3)/24:(1/3)/24:282,286:(1/3)/24:287];
% plotdir = 'spgtides'
